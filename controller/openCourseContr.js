...
//全部课程展示控制器
var app = angular.module('openCourseApp',[]);

app.controller('openCourseContr',function($scope,$http,$location){
	...
	//获取所有免费课程信息
	$http.get($location.path()+'/watch/queryAllFreeCourse').then(function(resp){
